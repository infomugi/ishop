          ...
          <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7">
            <div class="product-details-area">
              ...
              <?php if($model->discount!=0){ ?>
                ...
                <?php }else{ ?>
                     <div class="price-box">
                    <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> <?php echo Product::model()->callus($model->callus); ?> </span> </p>
                  </div>
                  <?php } ?>
                    ...
                    <form action="#" method="post">
                      ...
                      -->
                          <?php echo CHtml::link("<span><i class='fa fa-shopping-cart'></i> Add to Cart</span>", 
                              array('order/add', 'product'=>$model->id_product,
                                ), array('class' => 'btn btn-default btn-lg pull-right pro-add-to-cart', 'title'=>'Add to Cart'));
                                ?>
                        </form>
                      </div>
                    <?php endif; ?>
                      <div class="product-cart-option">
                        <ul>
                          <li>
                            <?php echo CHtml::link("<i class='fa fa-thumbs-up'></i> Like</span>", 
                              array('product/likes', 'id'=>$model->id_product), array('title'=>'Likes'));
                                ?>
                                  </li>
