...
class EmployeeController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('create','update','view','delete','admin','index','profile'),
				'users'=>array('@'),
	...
	public function actionView($id)
	{
		...
		$user=$this->loadUser($model->user_id);
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Employee'], $_POST['User']))
		{
