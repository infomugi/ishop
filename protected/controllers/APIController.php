...
/**
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('detail','index','quickview','likes','like'),
				'users'=>array('*'),
				),
			array('allow',
...
public function actionSub()
  {
      ...
      $query = "SELECT * FROM category_sub WHERE id = '$_POST['id']' ORDER BY update_date DESC";
      $command = Yii::app()->db->createCommand($query);
      $result = $command->queryAll();
